...
public interface TextViewBind extends ViewBind, Parcelable, DataPools.Poolable {
...
======================================================================= */
    ...
    TextViewBind setEnable(boolean enable1);

    TextViewBind setBackgroundRes(int backgroundRes1);

    TextViewBind setBackgroundColor(int backgroundColor1);

    TextViewBind setBackground(Drawable background1);

    TextViewBind setVisible(boolean visible1);
}
