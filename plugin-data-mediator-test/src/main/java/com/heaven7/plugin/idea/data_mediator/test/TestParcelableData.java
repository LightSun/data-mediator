...
//any object
        ...
        @Field(propName = "test_ResultData_list", type = FlowItem.class, flags = FLAGS_ALL_SCOPES, complexType = COMPLEXT_LIST),
        @Field(propName = "test_ResultData_array", type = FlowItem.class, flags = FLAGS_MAIN_SCOPES, complexType = COMPLEXT_ARRAY),
// sparseArray
