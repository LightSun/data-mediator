...
public interface TestParcelableData extends Serializable, IResetable, DataPools.Poolable {
    ...
    Property PROP_test_ResultData = SharedProperties.get(FlowItem.class.getName(), "test_ResultData", 0);
    Property PROP_test_ResultData_list = SharedProperties.get(FlowItem.class.getName(), "test_ResultData_list", 2);
    Property PROP_test_ResultData_array = SharedProperties.get(FlowItem.class.getName(), "test_ResultData_array", 1);
    Property PROP_test_SparseArray = SharedProperties.get(FlowItem.class.getName(), "test_SparseArray", 3);
