 ...
 *  @author heaven7 */
public class TestItem3_$Proxy extends BaseMediator<TestItem3> implements TestItem3 {
  public TestItem3_$Proxy(TestItem3 base) {
    super(base);
  }
  ...
  public ListPropertyEditor<? extends TestItem3, String> beginTestItem2_3Editor() {
    TestItem3 target = _getTarget();
    ...
    return new ListPropertyEditor<TestItem3,String>(target, values, PROP_testItem2_3, this);
  }
  ...
  public String getTestItem3() {
    return _getTarget().getTestItem3();
  }

  public TestItem3 setTestItem3(String testItem31) {
    TestItem3 target = _getTarget();
    String oldValue = target.getTestItem3();
    if(_getEqualsComparator().isEquals(oldValue, testItem31)) {
      return this;
    }
    target.setTestItem3(testItem31);
    dispatchValueChanged(PROP_testItem3, oldValue, testItem31);
    return this;
  }
  ...
  public ListPropertyEditor<? extends TestItem3, String> beginDescEditor() {
    TestItem3 target = _getTarget();
    ...
    return new ListPropertyEditor<TestItem3,String>(target, values, PROP_desc, this);
  }
  ...
  public SparseArrayPropertyEditor<? extends TestItem3, Integer> beginXxx3Editor() {
    TestItem3 target = _getTarget();
    ...
    return new SparseArrayPropertyEditor<TestItem3,Integer>(target, DataMediatorDelegate.getDefault().getSparseArrayDelegate(values), PROP_xxx3, this);
  }
  ...
  public void applyProperties(PropertyInterceptor interceptor) {
    ...
    startBatchApply(interceptor)
      ...
      .addProperty(PROP_testItem3, getTestItem3())
