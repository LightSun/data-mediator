...
# Features
* 1, Auto generate 'data-impl' and 'data-proxy' (use plugin to generare methods od 'data-module'). support listen property change, [Detail](docs/en/listen_property_change.md)
...
* 10, Full support Data-binding on android.
  * [Manually bind](docs/en/data_bind.md) 
  * [Bind by Annotations](https://github.com/LightSun/data-mediator/releases/tag/1.4.0)
