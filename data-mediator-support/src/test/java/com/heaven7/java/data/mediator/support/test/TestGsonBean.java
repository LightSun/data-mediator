...
public class TestGsonBean {
    ...
    public static final Property PROP_car = new Property("com.heaven7.java.data.mediator.support.test.Car3",
            "car", 0);
    public static final Property PROP_mList = new Property("com.heaven7.java.data.mediator.support.test.Car3",
            "list", FieldFlags.COMPLEX_LIST);
    public static final Property PROP_carsArr = new Property("com.heaven7.java.data.mediator.support.test.Car3",
            "carsArr", FieldFlags.COMPLEX_ARRAY);
    public static final Property PROP_carMap = new Property("com.heaven7.java.data.mediator.support.test.Car3",
